  ...
  const onSubmit = () => {
    ...
    axios.post(
      'https://sheet.best/api/sheets/a4155965-1e53-4ade-995d-a4c0b81f7fea',
      {
        ...
        "baseSalary": baseSalary, "variableSalary": variableSalary, "stockSalary": stockSalary, "bonusSalary": bonusSalary,
      ...
      <FormContentHeaderWrapper>
        ...
        <InfoWrapper>
          <Popup
            ...
            <div style={{ fontSize: "0.9rem", color: "#425466", padding: "0.5rem" }}>
              The yearly salary you receive from your job. You may leave the variable, stocks, and bonus fields blank if they do not apply to you.
            </div>
            <div style={{ fontSize: "0.9rem", color: "#425466", padding: "0 0.5rem 0.5rem 0.5rem" }}>
            ...
            <div style={{ fontSize: "0.9rem", color: "#425466", padding: "0 0.5rem 0.5rem 0.5rem" }}>
              <b>Stocks</b>: The monetary value of the RSUs (Restricted Stock Units) you receive yearly.
            </div>
            <div style={{ fontSize: "0.9rem", color: "#425466", padding: "0 0.5rem 0.5rem 0.5rem" }}>
              <b>Bonus</b>: Any one-time payments, such as the Annual Wage Supplement (13th month bonus)
            </div>
          </Popup>
        </InfoWrapper>
      </FormContentHeaderWrapper>
