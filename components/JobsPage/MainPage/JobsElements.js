...
export const JobsCardLink = styled(Link)`
    text-decoration: none;  
`;

export const JobsCardWrapper = styled.div`
    width: 100%;
...
export const JobsTopWrapper = styled.div`
    display: flex;
    flex-direction: row;
    padding-top: 0.5rem;
    padding-left: 0.5rem;
...
export const JobsTopWrapper2 = styled.div`
    display: flex;
    flex-direction: column;
    padding-left: 1rem;
`;

export const JobsLogo = styled.div`
    height: 5rem;
    width: 5rem;
...
export const JobsAbout = styled.p`
    font-size: 0.875rem;
    color: #404040;
...
export const JobsSubmissions = styled.p`
    color: #425466;
    font-size: 0.9375rem;
`;

export const JobsAllWrapper = styled.div`
    display: flex;
    flex-direction: row;
    flex-wrap: wrap;
    justify-content: center;
